...
const createProducts = async ({
  ...
  try {
    const {
      ...
      `
            INSERT INTO products(name, description, "creatorId", price, "productImage", "productStock")
            VALUES ($1, $2, $3, $4, $5, $6)
            RETURNING *;
        `,
      [name, description, creatorId, price, productImage, productStock]
    );
    ...
    return await addReviewsToProducts(
      products.id,
      reviewList,
      products.creatorId
    );
